...
namespace APIMuhasibat.Controllers
{
    ...
    [ApiController]
    public class NavbarsController : BaseController
    {
        ...
        [AllowAnonymous]
        [Route("_Getoken")]
        private string _Getoken() { return _gettoken().ToString(); }

        [HttpPost]
        [AllowAnonymous]
        [Route("_Getrole")]
        private string _Getrole() { return _GetRole(); }
        [HttpPost]
        [AllowAnonymous]
        [Route("_Getemail")]
        private string _Getemail() { return _GetEmail(); }
        [HttpPost]
        [AllowAnonymous]
        [Route("_GetId")]
        private string _GetId() { return _GetId(); }
        ...
        public IActionResult _getnavbar()//string[] rol
        {
            var rol = _GetRole();
            ...
            if (rol!= null)
            {
                var res = (from a in _nav.GetAll()
                           ...
                           // where rol.Any(id => c.NormalizedName == rol)
                           where c.NormalizedName == rol
                           select new
                           {
                               a.nid,
                               a.pid,
